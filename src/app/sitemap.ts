...
const ROUTES: Array<{
  ...
  { path: "/produkty/sunscreen", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/sun-cushion", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/reset-balm", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/herbal-sampon", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/herbal-kondicioner", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/scalpcare-sampon", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/scalpcare-kondicioner", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/biotic-10", changeFrequency: "monthly", priority: 0.7 },
  { path: "/produkty/hongsamdan", changeFrequency: "monthly", priority: 0.7 },
  { path: "/jak-nakupovat", changeFrequency: "monthly", priority: 0.7 },
